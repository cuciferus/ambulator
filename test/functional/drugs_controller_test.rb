...
class DrugsControllerTest < ActionController::TestCase
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post :create, drug: { cantitate: @drug.cantitate, cod: @drug.cod, dci: @drug.dci, diagnostic: @drug.diagnostic, nume: @drug.nume }
    end
  ...
  test "should update drug" do
    put :update, id: @drug, drug: { cantitate: @drug.cantitate, cod: @drug.cod, dci: @drug.dci, diagnostic: @drug.diagnostic, nume: @drug.nume }
    assert_redirected_to drug_path(assigns(:drug))
  end
